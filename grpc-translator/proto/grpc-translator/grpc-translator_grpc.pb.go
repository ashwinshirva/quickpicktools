...
func (c *frontendClient) Homepage(ctx context.Context, in *HomepageRequest, opts ...grpc.CallOption) (*HomepageRespone, error) {
	out := new(HomepageRespone)
	err := c.cc.Invoke(ctx, "/grpc_translator.Frontend/Homepage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFrontendServer) Homepage(context.Context, *HomepageRequest) (*HomepageRespone, error) {
...
func _Frontend_Homepage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_translator.Frontend/Homepage",
	}
